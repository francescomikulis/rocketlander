...
/*
This files has endless examples of how to access the data from the SimulationStatus.

CSVSaveListener.java
 */

public class CustomCSVSaveListener extends AbstractSimulationListener {
	...
	public boolean handleFlightEvent(SimulationStatus status, FlightEvent event) throws SimulationException {
		...
		if (event.getType() == FlightEvent.Type.LAUNCH) {
			...
			final net.sf.openrocket.simulation.extension.impl.CustomCSVSaveListener.Types[] types = net.sf.openrocket.simulation.extension.impl.CustomCSVSaveListener.Types.values();
