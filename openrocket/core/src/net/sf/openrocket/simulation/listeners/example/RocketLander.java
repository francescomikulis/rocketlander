 ...
 * <p>
 * The altitude is read from the system property "openrocket.rocketlander.altitude"
 * if defined, otherwise a default altitude of 1000 meters is used.
 */
public class RocketLander extends AbstractSimulationListener {
	...
	public void startSimulation(SimulationStatus status) throws SimulationException {
		...
		double altitude;
		String arg = System.getProperty("openrocket.rocketlander.altitude");
		try {
